...
#                            item_stats GET    /items/:item_id/item_stats(.:format)                                                     item_stats#index
#                                       POST   /items/:item_id/item_stats(.:format)                                                     item_stats#create
#                         new_item_stat GET    /items/:item_id/item_stats/new(.:format)                                                 item_stats#new
#                        edit_item_stat GET    /items/:item_id/item_stats/:id/edit(.:format)                                            item_stats#edit
#                             item_stat GET    /items/:item_id/item_stats/:id(.:format)                                                 item_stats#show
#                                       PATCH  /items/:item_id/item_stats/:id(.:format)                                                 item_stats#update
#                                       PUT    /items/:item_id/item_stats/:id(.:format)                                                 item_stats#update
