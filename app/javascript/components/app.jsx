...
export default function App() {
  ...
  const list1Items = [
    ...
    <ListItem
      button
      key={el.name}
      onClick={(e) => handleDrawerPath(el.path, e)}
    >
      <ListItemIcon>
        <CardMedia className={classes.icon} image={el.img} title={el.name} />
      </ListItemIcon>
  ...
  return (
    <div className={classes.root}>
          ...
          {auth && (
            <div>
              <IconButton
                ...
                color="inherit"
              >
                <Typography className={classes.greeting}>{username}</Typography>
                <AccountCircle />
              </IconButton>
              <Menu
                id="menu-appbar"
                ...
                onClose={handleClose}
              >
                <MenuItem onClick={(e) => handlePath("/profile", e)}>
                  Profile
                </MenuItem>
      ...
      >
        ...
        <Divider />
        <List>{list1Items}</List>
        <Divider />
        <List>{list2Items}</List>
      </Drawer>
      <main
